...
function createCard(cityData) {
    let maxTemp = Math.round(cityData.main.temp_max);
    let minTemp = Math.round(cityData.main.temp_min);
    let cityName = cityData.name + ',' + cityData.sys.country;
    let temperature = Math.round(cityData.main.temp);
